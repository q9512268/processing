...
public class CompilerCUSTOM {
   ...
   *
   * @param data.sketch Sketch object to be compiled, used for placing exceptions
   * @param buildPath Where the temporary files live and will be built from.
   * @return true if successful.
   * @throws SketchException Only if there's a problem. Only then.
   */
  static public boolean compileCUSTOM(JavaBuildCUSTOM build) throws SketchException {
    ...
    try {
      polyglotMain.start(commandCUSTOM, new ent.EntExtensionInfo());
...
private static String[] generateCommandCUSTOM(JavaBuildCUSTOM build) {
	...
	File expectedFolder = new File("/Users/christianluetticke/Documents/processing/java/src/test/output/");
    ...
    //String[] sourceFiles = Util.listFiles(build.getSrcFolder(), false, ".java");
    //PApplet.println("build.getSrcFolder(): " + build.getSrcFolder());
    
    String[] sourceFiles = Util.listFiles(expectedFolder, false, ".java");
    PApplet.println("build.getSrcFolder(): " + build.getSrcFolder());
